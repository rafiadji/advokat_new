					...
					<div class="header-row">
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container one-page-menu">
								<li class="menu-item current"><a class="menu-link" href="<?php echo site_url(''); ?>">
										<div>Home</div>
									</a></li>
								<?php if ($this->session->userdata('username') != NULL) : ?>
									<li class="menu-item"><a class="menu-link" href="<?php echo site_url('client/profile'); ?>">
											<div>Profil</div>
										</a></li>
									<li class="menu-item"><a class="menu-link" href="<?php echo site_url('client/daftarkonsultasi'); ?>">
											<div>Daftar Kosultasi</div>
										</a></li>
									<li class="menu-item"><a class="menu-link" href="<?php echo site_url('client/konsultasi'); ?>">
											<div>Kosultasi</div>
										</a></li>
									<li class="menu-item"><a class="menu-link" href="<?php echo site_url('logincalonklien/logout'); ?>">
											<div>Logout</div>
										</a></li>
								<?php else : ?>
									<li class="menu-item"><a href="#myModal1" data-lightbox="inline" class="menu-link">
											<div>Login</div>
										</a></li>
								<?php endif; ?>
							</ul>
						...
						<div class="modal1 mfp-hide" id="myModal1">
							<div class="block mx-auto" style="background-color: #FFF; max-width: 700px;">
								<div class="row m-0">
									<div class="col-md-6" data-height-xl="456" data-height-lg="456" data-height-md="456" data-height-sm="0" data-height-xs="0" style="background-image: url(<?php echo base_url('assets/front/images/4.jpg'); ?>); background-size: cover;">
									</div>
							...
							<div class="row col-mb-50">
								<div class="col-md-4">
									...
									<div class="widget clearfix">
										...
										<img src="<?php echo base_url('assets/front/images/logo.png'); ?>" alt="Image" class="footer-logo">

										<p>We Are <strong>Your</strong> progressive &amp; <strong>Law Partner</strong> .
										</p>

										<div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
											<address>
												<strong>Headquarter :</strong><br>
												Jl. Wisnuwardhana KAv A3<br>
												Sawojajar, Kota Malang 65139<br>
											</address>
											<abbr title="Phone Number"><strong>Phone:</strong></abbr> (+62) 822 3342
											42<br>
											<abbr title="Email Address"><strong>Email:</strong></abbr>
											buyandpartners@gmail.com
										</div>
							...
							<div class="row col-mb-50">
									...
									<div class="widget clearfix" style="margin-bottom: -20px;">
										...
										<div class="row">
											<div class="col-lg-6 bottommargin-sm">
												<div class="counter counter-small"><span data-from="20" data-to="150" data-refresh-interval="20" data-speed="3000" data-comma="true"></span></div>
												<h5 class="mb-0">Total Case</h5>
											</div>

											<div class="col-lg-6 bottommargin-sm">
												<div class="counter counter-small"><span data-from="100" data-to="1846" data-refresh-interval="50" data-speed="2000" data-comma="true"></span></div>
								...
								<div class="col-md-5 col-lg-12">
									<div class="widget subscribe-widget clearfix">
										<h5>Started as legal laboratory,
											the law firm was built to
											prepare fresh law graduate
											to work on the real world.
											Buyung Law Firm offers broad
											services and provide top-tier
											legal services that address
											client business issues and needs.
											Start with environmental law
											as our main base, but now we
											are also provide consultation
											on business law, natural resources
											and mining law, fair trade,
											general corporate and commercial law.</h5>
									...
									<div class="widget clearfix" style="margin-bottom: -20px;">
										...
										<div class="row">
											...
											<div class="col-6 col-md-12 col-lg-6 clearfix">
												...
												<a href="#"><small style="display: block; margin-top: 3px;"><strong>Follow us</strong><br>
														on Instagram</small></a>
											</div>
										</div>
				...
				<div class="container">
					...
					<div class="row col-mb-30">
						...
						<div class="col-md-6 text-center text-md-left">
							Copyrights &copy; 2021 All Rights Reserved by Buyung Law Firm.<br>
