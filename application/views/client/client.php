<section id="slider" class="slider-element slider-parallax dark min-vh-60 min-vh-md-100 include-header" style="background: url(<?php echo base_url('assets/front/images/landing/landing1.jpg'); ?>) center;">
            ...
            <div class="container py-5">
                ...
                <form action="<?php echo site_url('client/daftar'); ?>" method="post" class="landing-wide-form row align-items-center mb-0" data-animate="fadeIn">
                    ...
                    <div class="col-12 col-md-auto">
                        <button class="btn btn-lg btn-danger btn-block m-0" value="submit" type="submit">Daftar Sekarang</button>
                    </div>
                </form>
            ...
            <div class="pricing-box pricing-extended row align-items-stretch mb-5 mx-0">
                ...
                <div class="pricing-action-area col-lg d-flex flex-column justify-content-center">
                    ...
                    <div class="pricing-action">
                        <a href="#" class="button button-3d button-large btn-block m-0">Get Started</a>
                    </div>
                </div>
            </div>
        ...
        <div class="section footer-stick">
            ...
            <div class="container clearfix">
                ...
                <div class="center">
                    ...
                    <a href="#" data-animate="tada" class="button button-3d button-teal button-xlarge mb-0"><i class="icon-star3"></i>Start your FREE Trial</a> - OR - <a href="#" data-scrollto="#section-pricing" class="button button-3d button-red button-xlarge mb-0"><i class="icon-user2"></i>Sign Up for a Subscription</a>
