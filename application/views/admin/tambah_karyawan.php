...
<section class="content">
	<form class="" method="post" action="<?php echo site_url('admin/tambahKaryawanSubmit') ?>" style="opacity:1;">
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group"> <label class="">Nomor Induk Advokat</label>
					<input type="number" name="no_induk_advokat" class="form-control" placeholder="Nomor Induk Anggota Advokat">
				</div>
